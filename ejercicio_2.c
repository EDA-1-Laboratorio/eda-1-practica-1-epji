...
// RESPUESTA: En este caso, el programa podria intentar recorrer otra vez la fila inferior aunque ya no haya un espacio válido. Prácticamente la verificación if evita que el programa recorra filas que ya fueron llenadas.
